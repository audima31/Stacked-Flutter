...
import 'package:my_first_app/ui/views/news/news_view.dart' as _i4;
import 'package:my_first_app/ui/views/shop/shop_view.dart' as _i6;
...
class StackedRouter extends _i1.RouterBase {
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i4.NewsView: (data) {
      return _i7.MaterialPageRoute<dynamic>(
        builder: (context) => const _i4.NewsView(),
        settings: data,
      );
    },
    _i5.LoginView: (data) {
    ...
    _i6.ShopView: (data) {
      return _i7.MaterialPageRoute<dynamic>(
        builder: (context) => const _i6.ShopView(),
        settings: data,
      );
    },
  };
